...
### 2. DESC –
Command used to view the table structure. 
...
This is used to change the width as well as data 
...
### PRIMARY KEY -
A combination of a NOT NULL and UNIQUE. Uniquely identifies each row in 
a table 
### FOREIGN KEY - 
...
## 2. UNIQUE:
The purpose of a unique key is to ensure that information in the column(s) is 
...
## 5. FOREIGN KEY:
It is a table level constraint. We cannot add this at column level. To 
